...
parser.add_argument('--w_bits', default=2, type=int, help='the bit-width of the quantized network')
parser.add_argument('--a_bits', default=2, type=int, help='the bit-width of the quantized network')
