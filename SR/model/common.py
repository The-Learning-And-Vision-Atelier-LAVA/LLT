...
from model.quant_layer import QuantConv2d
    ...
    def __init__(self, conv, n_feats, kernel_size, bias=True, bn=False, act=nn.ReLU(True), res_scale=1,
        ...
        for i in range(2):
            if w_bits == 32 and a_bits == 32:
                ...
                if i == 0:
                    m.append(QuantConv2d(n_feats, n_feats, kernel_size, bias=bias, w_bits=w_bits, a_bits=a_bits, sign=False))
                else:
                    m.append(QuantConv2d(n_feats, n_feats, kernel_size, bias=bias, w_bits=w_bits, a_bits=a_bits, sign=True))
